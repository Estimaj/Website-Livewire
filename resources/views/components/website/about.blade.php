    ...
    <div class="bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:text-center">
                <h2 class="heading_container mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl lg:text-balance">How am I</h2>
                <p class="mt-6 text-lg/8 text-gray-600">I'm a Portuguese Software Engineer with over half a decade of experience in web development.</p>
            </div>
