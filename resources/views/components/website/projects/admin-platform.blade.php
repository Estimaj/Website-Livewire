<div x-show="isAdminPlatformModalActive" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">

  <div class="fixed inset-0 bg-gray-500/75 transition-opacity" aria-hidden="true"></div>

  <div class="fixed inset-0 z-10 w-screen overflow-y-auto" x-on:click="isAdminPlatformModalActive = false" x-data="{ selectedImage: 0 }">
    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
      <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 w-full lg:max-w-6xl" x-on:click.stop="">
        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4" x-on:click="selectedImage = selectedImage > 3 ? 0 : selectedImage + 1">
